...
export default function FeaturedCourses({ onSelectCourse, onExploreAll }: FeaturedCoursesProps) {
        ...
        return (
          <div className="absolute top-4 right-4 w-28 h-28 opacity-90 select-none hidden sm:block pointer-events-none">
            <svg viewBox="0 0 100 100" className="w-full h-full text-blue-500 drop-shadow-md">
              <polygon points="50,10 85,80 15,80" fill="none" stroke="currentColor" strokeWidth="2.5" />
              <circle cx="50" cy="50" r="18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeDasharray="3,3" />
              <line x1="50" y1="10" x2="50" y2="80" stroke="currentColor" strokeWidth="1.5" strokeDasharray="2,2" />
              <path d="M 40 80 A 10 10 0 0 1 50 70" fill="none" stroke="currentColor" strokeWidth="2" />
              <path d="M 50 15 L 35 45 M 50 15 L 65 45 M 35 45 L 30 70 M 65 45 L 70 70" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
            </svg>
          </div>
        );
      case 'highschool':
        return (
          <div className="absolute top-4 right-4 w-28 h-28 opacity-90 select-none hidden sm:block pointer-events-none">
            <svg viewBox="0 0 100 100" className="w-full h-full text-[#38bdf8] drop-shadow-lg">
              <polygon points="50,20 80,35 80,65 50,80 20,65 20,35" fill="none" stroke="currentColor" strokeWidth="2.5" />
              <line x1="50" y1="20" x2="50" y2="80" stroke="currentColor" strokeWidth="2.5" />
              ...
              <line x1="20" y1="65" x2="50" y2="50" stroke="currentColor" strokeWidth="1.5" strokeDasharray="2,2" />
              <line x1="80" y1="65" x2="50" y2="50" stroke="currentColor" strokeWidth="1.5" strokeDasharray="2,2" />
            </svg>
          </div>
        );
      case 'vsat':
        return (
          <div className="absolute top-4 right-4 w-28 h-28 opacity-95 select-none hidden sm:block pointer-events-none">
            <svg viewBox="0 0 100 100" className="w-full h-full text-violet-500 drop-shadow-lg">
              <circle cx="50" cy="50" r="35" fill="none" stroke="currentColor" strokeWidth="3" />
              <circle cx="50" cy="50" r="23" fill="none" stroke="currentColor" strokeWidth="2" strokeDasharray="1,1" />
              <circle cx="50" cy="50" r="12" fill="none" stroke="currentColor" strokeWidth="2.5" />
              <line x1="15" y1="15" x2="45" y2="45" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
              <polygon points="45,45 42,38 38,42" fill="currentColor" />
              <path d="M 50 5 L 50 95 M 5 50 L 95 50" fill="none" stroke="currentColor" strokeWidth="0.5" strokeDasharray="4,4" />
            </svg>
          </div>
        );
      default:
  ...
  return (
    <section id="courses-section" className="py-20 bg-slate-50 border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 animate-fade-in">
          <div className="space-y-3">
            ...
            <p className="text-slate-500 text-base max-w-2xl leading-relaxed font-sans">
              Các khóa học ôn thi trọng điểm được xây dựng công phu nhằm giúp các học sinh thấu hiểu sâu cơ chế, bứt phá tư duy Toán đại số và hình học.
            </p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {COURSES.map((course) => {
            let gradientClass = 'from-slate-900 to-blue-950/95';
            ...
            return (
              ...
              >
                ...
                <div className="space-y-4 z-10 text-left">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-black font-display text-white group-hover:text-blue-300 transition-colors leading-tight">
                      {course.tag}
                    </h3>
                  </div>
                ...
                <div className="mt-10 pt-6 border-t border-white/10 flex items-center justify-between z-10">
                  <div className="flex flex-col text-left">
                    <span className="text-[10px] text-slate-400 font-mono text-left">{course.lessonsCount} bài học video</span>
