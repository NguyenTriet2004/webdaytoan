      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <div>
              <span className="block text-[10px] font-bold uppercase tracking-wider text-blue-400 font-display leading-none mb-1">
                Nền tảng trực tuyến
              </span>
          ...
          <nav className="hidden md:flex space-x-8 text-sm font-medium">
            {navItems.map((item) => (
              <button
                ...
                className="text-slate-300 hover:text-white hover:underline decoration-blue-505 decoration-2 underline-offset-8 transition-colors duration-200 cursor-pointer"
              >
                {item.label}
              </button>
            ))}
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {currentUser ? (
              <div className="flex items-center space-x-3 bg-slate-900 px-3.5 py-1.5 rounded-xl border border-slate-800">
                <div className="w-7 h-7 rounded-lg bg-blue-650/10 text-blue-400 font-bold flex items-center justify-center text-xs">
              ...
              <>
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-2.5 rounded-full text-sm font-semibold shadow-lg shadow-blue-600/25 transition-all duration-200 transform active:scale-95 cursor-pointer"
                >
                  Đăng ký
                </button>
              </>
            ...
            {currentUser ? (
              ...
              <>
                ...
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-500 text-white py-2.5 rounded-full font-semibold shadow-lg cursor-pointer"
                >
                  Đăng ký
                </button>
              </>
